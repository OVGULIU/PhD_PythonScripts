...
cwdAll = [
        # '/home/cerecam/Desktop/RVE_25_34_42_50/2M_NEW_96x96x96_25PER/NewDensitySims']
       '/home/cerecam/Desktop/RVE_25_34_42_50/2M_NEW_96x96x96_34PER/NewDensitySims']
       # '/home/cerecam/Desktop/RVE_25_34_42_50/2M_NEW_96x96x96_42PER/NewDensitySims']
       # '/home/cerecam/Desktop/RVE_25_34_42_50/2M_NEW_96x96x96_50PER/NewDensitySims']
for cwd in cwdAll:
    InpName = 'Concentration_EleSets'
    ...
    for line in lines[1:]:
        if line[0] == '*':
            ...
            np.savetxt(cwd + '/' + elset + '.csv', np.array(elements), delimiter=",", fmt='%i')
            ...
            np.savetxt(cwd + '/' + elset + '.csv', np.array(elements).astype(int), delimiter=",",
                       fmt='%i')
            #        print('csv file '+elset+' is written in '+cwd+ '/'+elset +'.csv')
            #         Writef.write(' /)')
            #         Writef.write('*' + split_line_name[1].split('=')[-1] + ' = (/ ')
