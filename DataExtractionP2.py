...
cwdDictionary = {}
cwdDictionary['/home/cerecam/Desktop/RVE_25_34_42_50/2M_NEW_96x96x96_25PER/HPC_25PER/'] = ['S1_25PER_new3_NoUEL.odb',
...
cwdDictionary['/home/cerecam/Desktop/RVE_25_34_42_50/2M_NEW_96x96x96_34PER/HPC_34PER/'] = ['S1_34PER_new2_NoUEL2.odb',
...
cwdDictionary['/home/cerecam/Desktop/RVE_25_34_42_50/2M_NEW_96x96x96_42PER/HPC_42PER/'] = ['S1_42PER_new2_NoUEL3.odb',
                                                                                           'S2_42PER_new3_NoUEL.odb',
                                                                                           'S3_42PER_new3_NoUEL.odb',
                                                                                           'S4_42PER_new3_NoUEL.odb',
                                                                                           'S5_42PER_new3_NoUEL.odb',
                                                                                           'S6_42PER_new3_NoUEL.odb']
cwdDictionary['/home/cerecam/Desktop/RVE_25_34_42_50/2M_NEW_96x96x96_50PER/HPC_50PER/'] = ['S1_50PER_new3_NoUEL2.odb',
...
for cwd, odblist in cwdDictionary.items():
    ...
    for odbName in odblist:
        ...
        for frame in allFrames:
            ...
            concList = []
            for i in Z1_P:
                concList.append(conc_array[int(i[0]) - 1][1])

            meanconc = np.mean(np.array(concList), 0)

            all_meanconc.append((lastFrameValue + frame.frameValue, meanconc))
            ...
            print >> sys.__stdout__, 'Average Concentration: \t' + str(meanconc)
    ...
    with open(cwd + fOut + '.csv', 'w') as fname:
        ...
        csvWriter.writerow(['Frame time: '] + [x[0] for x in all_meanconc])
        ...
        csvWriter.writerow(['Concentration polymer: '] + [x[1] for x in all_meanconc])
